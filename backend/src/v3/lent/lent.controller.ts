...
export class LentController {
  ...
  @ApiOperation({
    ...
    description:
      'cabinet_id에 해당하는 캐비넷을 user_id에 해당하는 유저에게 대여를 시도합니다.',
  })
  @ApiCreatedResponse({
  ...
  @ApiBadRequestResponse({
    description:
      '해당 캐비넷이나 유저가 존재하지 않는 경우 or 해당 유저가 이미 대여중인 사물함이 있는 경우, 400 Bad Request를 응답합니다.',
  })
  @ApiResponse({
  ...
  @ApiConflictResponse({
    description:
      '해당 캐비넷에 잔여 자리가 없는 경우 or 연체 사물함을 대여 시도한 경우 or 임시 밴 사물함이나 고장 사물함을 대여 시도한 경우, 409 Conflict를 응답합니다.',
  })
